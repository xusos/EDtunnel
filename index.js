...
let userID = '84c69b0e-ecd2-4016-808b-4052fd93a771';

let proxyIP = '';// 小白勿动，该地址并不影响你的网速，这是给CF代理使用的。'cdn.xn--b6gac.eu.org, cdn-all.xn--b6gac.eu.org, workers.cloudflare.cyou'

let sub = 'dyue.cmdl.cc';// 留空则使用内置订阅
let subconverter = 'zhuanhuan.cmdl.cc';// clash订阅转换后端，目前使用CM的订阅转换功能。自带虚假uuid和host订阅。
