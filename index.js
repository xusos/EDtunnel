...
let CMproxyIPs = [
	{ proxyIP: "proxyip.aliyun.fxxk.dedyn.io", type: "HKG" },
	{ proxyIP: "proxyip.oracle.fxxk.dedyn.io", type: "NLD" },
	{ proxyIP: "proxyip.us.fxxk.dedyn.io", type: "USA" },
	{ proxyIP: "proxyip.sg.fxxk.dedyn.io", type: "SIN" },
	{ proxyIP: "proxyip.jp.fxxk.dedyn.io", type: "JPN" },
	{ proxyIP: "proxyip.kr.fxxk.dedyn.io", type: "KOR" },
];
let BotToken ='';
let ChatID =''; 
...
export default {
	async fetch (request, env) {
		...
		if (mytoken !== '' && url.pathname.includes(mytoken)) {
			host = env.HOST || "nn.cmdl.cc";
			uuid = env.UUID || "84c69b0e-ecd2-4016-808b-4052fd93a771";
